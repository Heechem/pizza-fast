...
const Button = ({ children, disabled, to, type, onClick }) => {
  const base =
    "duration-250 focus inline-block rounded-full bg-yellow-400  font-semibold uppercase tracking-wide text-stone-800 transition-colors hover:bg-yellow-300 focus:bg-yellow-300 focus:outline-none focus:ring focus:ring-yellow-300 focus:ring-offset-2 disabled:cursor-not-allowed  cursor-pointer ";
  const styles = {
